var TTCart = {
	...
	itemNumChange : function(){
		$(".increment").click(function(){//＋
			...
			$.post("/shopping/add/"+_thisInput.attr("itemId") + ".html?num=1",function(data){
		...
		$(".quantity-text").blur(function() {
			var _thisInput = $(this);
			$.post("/shopping/add/"+_thisInput.attr("itemId")+".html?num="+_thisInput.val()+"&&modify=1",function(data){
				TTCart.refreshTotalPrice();
			});
		});
	},
