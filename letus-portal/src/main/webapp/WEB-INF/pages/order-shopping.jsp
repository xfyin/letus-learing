...
<div class="w w1 header clearfix">
    <div id="logo"><a href="/"><img src="/images/letus-logo.gif" alt="我们商城"></a></div>
</div>
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">我们快递<i
						class='qmark-icon qmark-tip'
						data-tips='由我们公司负责配送，速度很快，还接受上门刷卡付款服务'></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
